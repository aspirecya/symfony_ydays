 ...
 */
final class Version20200120203353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, salle_id_id INT DEFAULT NULL, date_arrivee DATETIME NOT NULL, date_depart DATETIME NOT NULL, prix INT NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_29A5EC2792419D3E (salle_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
